...
plugin({
	name: 'vue',
	// El parámetro se llama `armador` y no `constructor`: ese nombre sombrea una
	// propiedad global, y el linter lo marca como error. En los repositorios que
	// copiaron este archivo antes quedó con el nombre viejo.
	setup(armador) {
