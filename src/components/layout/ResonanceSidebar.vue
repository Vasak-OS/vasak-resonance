	...
	<aside class="flex w-full shrink-0 flex-col rounded-corner border border-ui-border bg-ui-bg/80 p-2 md:w-72">
		...
		<nav class="flex-1 space-y-2 overflow-y-auto px-1 py-3">
			<button
				...
				:key="section.id"
				type="button"
				class="flex w-full items-center gap-3 rounded-corner border px-3 py-2 text-left text-sm transition-[color,background-color,border-color,transform] duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] active:scale-[0.98]"
				:class="[
